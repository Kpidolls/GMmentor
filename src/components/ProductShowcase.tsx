    ...
    <section className="w-full flex flex-col items-center justify-center mt-10 mb-4 px-2 sm:px-4">
      ...
      <div className="relative w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-3xl">
        ...
        <button
          ...
          className="absolute left-2 top-1/2 -translate-y-1/2 z-10 p-2 sm:p-3 rounded-full bg-white border border-slate-200 shadow-md hover:bg-slate-100 transition disabled:opacity-50 text-2xl"
        ...
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 z-10 p-2 sm:p-3 rounded-full bg-white border border-slate-200 shadow-md hover:bg-slate-100 transition disabled:opacity-50 text-2xl"
          disabled={products.length < 2}
        >
          &#8594;
        </button>
        ...
        <div className="gyg-widget-container transition-all duration-300 min-h-[420px] sm:min-h-[440px] md:min-h-[480px] flex flex-col items-center">
          ...
          >
            <div
              className="w-full flex-1 flex items-center justify-center relative aspect-[4/3] sm:aspect-[16/9] bg-slate-50 p-4"
              style={{
                borderRadius: '1rem',
            ...
            <div className="w-full px-6 py-4 flex flex-col items-center">
              ...
              >
                ...
                <span
                className="inline-block text-slate-700 font-semibold underline underline-offset-2 group-hover:text-slate-900 transition-colors text-base sm:text-lg"
