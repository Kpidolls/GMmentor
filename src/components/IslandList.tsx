...
const IslandList = () => {
  const islands = [
    ...
    {
      title: '📍 Mykonos',
      img: '/assets/images/mykonos.webp',
    ...
    //   description: 'Discover the medieval charm and beautiful beaches of Rhodes.',
    //   link: '',
    //   target: '_blank',
    //   rel: 'noopener noreferrer',
    // },
    // {
    //   title: '📍 Corfu',
    //   img: '/assets/images/corfu.webp',
    //   description: 'A lush island with Venetian architecture and stunning coastlines.',
    //   link: '',
    //   target: '_blank',
    //   rel: 'noopener noreferrer',
    // },
