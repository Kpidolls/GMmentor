...
const IslandList = () => {
  const islands = [
    ...
    },
    {
      ...
      description: 'Golden beaches, traditional villages and vibrant nightlife.',
      link: 'https://www.google.com/maps/@36.8410395,23.4878836,9z/data=!4m6!1m2!10m1!1e1!11m2!2sFfFiTrPoXFuPtbOf-p1jJo2nmzvXjw!3e3?entry=ttu&g_ep=EgoyMDI1MDQxNi4xIKXMDSoJLDEwMjExNDUzSAFQAw%3D%3D',
      target: '_blank',
      rel: 'noopener noreferrer',
    },
    {
