...
const Terms = () => {
  ...
  <meta name="description" content={t('meta.termsDescriptionShort')} />
      ...
      <div className="container mx-auto p-4">
        ...
        <p className="mb-4 text-gray-600">
          ...
          <ul className="list-disc list-inside mb-4 text-gray-600">
            <li>Explore mapped locations for fun activities.</li>
            <li>Purchase custom maps.</li>
            <li>Access affiliate products related to activities and locations.</li>
          </ul>
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">3. User Accounts</h2>
          <p className="mb-4 text-gray-600">
            <strong>Registration:</strong> You may need to create an account to access certain features. You agree to provide accurate and complete information during registration.
          </p>
          <p className="mb-4 text-gray-600">
            <strong>Account Security:</strong> You are responsible for maintaining the confidentiality of your account information and for all activities that occur under your account. Notify us immediately if you suspect any unauthorized use of your account.
          </p>
          ...
          <ul className="list-disc list-inside mb-4 text-gray-600">
            ...
            <li>Distributing unsolicited promotional material (spam).</li>
            <li>Harassing or threatening other users.</li>
            <li>Interfering with the security or performance of our services.</li>
          </ul>
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">5. Content Ownership</h2>
          <p className="mb-4 text-gray-600">
            <strong>User Content:</strong> You retain ownership of any content you submit through Googlementor (e.g., reviews, photos). By submitting content, you grant us a worldwide, non-exclusive license to use, reproduce, and distribute such content in connection with our services.
          </p>
          <p className="mb-4 text-gray-600">
            <strong>Googlementor Content:</strong> All content provided by Googlementor is owned by us or our licensors. You may not use any content without our express written permission.
          </p>
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">6. Payment Terms</h2>
          <p className="mb-4 text-gray-600">
            Certain features may require payment. By providing payment information, you authorize us to charge your payment method for applicable fees. All payments are non-refundable unless otherwise specified.
          </p>
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">7. Termination</h2>
          <p className="mb-4 text-gray-600">
            We reserve the right to suspend or terminate your access to Googlementor at our discretion if you violate these Terms or engage in harmful conduct.
          </p>
          ...
          <p className="mb-4 text-gray-600">
            You agree to indemnify and hold harmless Googlementor and its affiliates from any claims, losses, liabilities, damages, costs, or expenses arising out of your use of our services or violation of these Terms.
          </p>
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">10. Changes to Terms</h2>
          <p className="mb-4 text-gray-600">
            We may update these Terms from time to time. We will notify you about significant changes by posting a notice on our site or sending an email. Your continued use of the services after such changes constitutes acceptance of the new Terms.
          </p>
          ...
          <p className="mb-4 text-gray-600">
            Address: Fitzrovia House, 153 – 157 Cleveland Street, London W1T 6QW
          </p>
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">Terms for Promoting Matcharisma</h2>
          <p className="mb-4 text-gray-600">
